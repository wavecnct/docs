...
In this document, we provide a step-by-step guide on how users can integrate Salesforce in their Wave account to sync contacts and lead across the Salesforce ecosystem.
...
4.  A pop-up will open, allowing you to turn on contact auto sync between your Wave and Salesforce accounts. We recommend leaving this on. Press '**Continue**.' A new tab will open asking you to authenticate your Salesforce account.<br /><br />
    <img src="/salesforce-auto-sync-contacts.png" alt="Toggle Auto Sync" width="300px" />
    <br />
...
8.  Verify a successful integration of Salesforce by spotting the ‘**Disconnect**’ button across Salesforce.<br /><br />
    <img src="/salesforce-disconnect.png" alt="Disconnect Button" width="500px" />
    <br />
    <Callout type="info">
